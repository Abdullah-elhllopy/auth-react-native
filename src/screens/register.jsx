...
export default function Register({ navigation }) {
    ...
    const handleFormSubmit = async() => {
        if (handleEmailValidation() && handlePasswordValidation()) {
            await API.request('login.php' , 'POST' ,{
                email,
                password
            }).then((res)=>{
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.buttonContainer}>
                    <Text style={{ color: theme.colors.secondary, fontSize: 28, fontWeight: 700, lineHeight: 34 }}>Sign Up </Text>
                    <View>
                        <LabeledInput
                            label={'Email'}
                    ...
                    >
                        <Pressable style={theme.row} onPress={handleFormSubmit} >
                            <Text style={{ color: theme.colors.white, fontSize: 20 }}>Sign Up </Text>
